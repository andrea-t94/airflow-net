...
1. **Airflow Instructions** (`source: "airflow"`) - 6,738 samples (81.8%)
...
2. **Magpie General Python** (`source: "magpie"`) - 1,500 samples (18.2%)
...
# Load the dataset
dataset = load_dataset("USER/airflow-dag-dataset")
...
These samples are subsets from the [**Magpie-Align/Magpie-Qwen2.5-Coder-Pro-300K-v0.1**](https://huggingface.co/datasets/Magpie-Align/Magpie-Qwen2.5-Coder-Pro-300K-v0.1) dataset.
...
- **Total conversations:** 8,238
- **Airflow examples:** 6,738 (81.8%)
- **Magpie examples:** 1,500 (18.2%)
...
@misc{airflow-dag-dataset,
  ...
  url={https://huggingface.co/datasets/USER/airflow-dag-dataset}
}
```
